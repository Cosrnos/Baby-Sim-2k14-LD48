...
ac_interact_baby_tut.OnLoad = function(){
	...
	case "hold_baby":
		...
		base.SetMessage("<h3>No longer lonely!</h3>"
			...
			+"<p>With this knowledge of interacting with babies, you are now equipped to help shape the future of the little grease monkey! Any interaction will impact the child. For instance, holding it has increased its happiness by 40 and we've also given it a growth hormone to make it a little bit stronger!</p>");
